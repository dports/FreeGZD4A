  ...
  public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
    ...
    for (int n = 0; n < configs.length; n++) {
      ...
      eglConfigsString
          .append(n)
          .append(": ")
          .append(printConfig(egl, display, configs[n]))
          .append(",");
    }
    ...
    Log.i(
        LOG,
        "selected EGL config[" + selected + "]: " + printConfig(egl, display, configs[selected]));
  ...
  private String printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
    ...
    */
    ...
    return String.format("rgba=%d%d%d%d z=%d sten=%d", r, g, b, a, d, s)
        ...
        + String.format(
            " c=0x%04x", findConfigAttrib(egl, display, config, EGL10.EGL_CONFIG_CAVEAT, 0));
  }
