...
public class EntryActivity extends FragmentActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    actionBar.addTab(
        actionBar
            ...
            .setTabListener(new TabListener<>(this, "Gzdoom", LaunchFragmentGZdoom.class)));
    actionBar.addTab(
        actionBar
            .newTab()
            .setText(R.string.gamepad_tab)
            .setTabListener(new TabListener<>(this, "gamepad", GamePadFragment.class)));
    actionBar.addTab(
        actionBar
            .newTab()
            .setText(R.string.options_tab)
            .setTabListener(new TabListener<>(this, "options", OptionsFragment.class)));
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (gamePadFrag.onKeyDown(keyCode, event)) return true;
  ...
  public boolean onKeyUp(int keyCode, KeyEvent event) {
    ...
    if (gamePadFrag.onKeyUp(keyCode, event)) return true;
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE) {
      if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        ...
        launchFragmentGZdoom =
            (LaunchFragmentGZdoom) getFragmentManager().findFragmentByTag("Gzdoom");
        ...
        Toast.makeText(
                getActivity(),
                getResources().getString(R.string.file_permission_fail_toast),
                Toast.LENGTH_LONG)
            .show();
      }
    }
