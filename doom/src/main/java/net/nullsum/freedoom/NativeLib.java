...
public class NativeLib implements ControlInterface {
  ...
  public static final int SDL_SCANCODE_POWER =
      102; // Hack this is overridden to give an underscore instead
  ...
  public static native void setTouchSettings(
      float alpha, float strafe, float fwd, float pitch, float yaw, int other);
  ...
  @Override
  public void setTouchSettings_if(
      float alpha, float strafe, float fwd, float pitch, float yaw, int other) {
