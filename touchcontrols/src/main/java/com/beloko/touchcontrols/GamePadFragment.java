...
public class GamePadFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    enableCb.setOnCheckedChangeListener(
    ...
    hideCtrlCb.setOnCheckedChangeListener(
        (buttonView, isChecked) -> {
    ...
    listView.setOnItemLongClickListener(
        (arg0, v, pos, id) -> config.showExtraOptions(getActivity(), pos));
  ...
  public boolean onGenericMotionEvent(MotionEvent event) {
    ...
    if (config.onGenericMotionEvent(genericAxisValues)) adapter.notifyDataSetChanged();
