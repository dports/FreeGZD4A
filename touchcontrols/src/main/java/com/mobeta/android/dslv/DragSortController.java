 ...
 * creation.
 *
 * <p>An instance of this class is meant to be passed to the methods and of your {@link
...
public class DragSortController extends SimpleFloatViewManager
  ...
  /**
   * Calls with a 0 drag handle id, FLING_RIGHT_REMOVE remove mode, and ON_DOWN drag init. By
  ...
  /**
   * Enable/Disable list item sorting. Disabling is useful if only item removal is desired. Prevents
   * drags in the vertical direction.
   *
