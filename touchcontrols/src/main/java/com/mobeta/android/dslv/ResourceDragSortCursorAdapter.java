...
/**
 * Static library support version of the framework's {@link ResourceCursorAdapter}. Used to write
...
public abstract class ResourceDragSortCursorAdapter extends DragSortCursorAdapter {
   ...
   *     Unless you override them later, this will define both the item views and the drop down
   *     views.
  ...
  /**
   * Constructor with default behavior as per ; it is recommended you not use this, but instead .
